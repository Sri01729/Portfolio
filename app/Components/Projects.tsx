...
import { FaGithub, FaLinkedin, FaPython, FaFirefox } from 'react-icons/fa';
...
const Projects = () => {
  ...
  {
    title: "Dhvani",
    description: "Dhvani is a music streaming service that personalizes playlists based on your mood, weather, and location. By integrating advanced algorithms and APIs, it ensures the music perfectly complements your surroundings and emotions.",
    tags: ["HTML", "CSS", "Javascript", "OpenAI"],
    link: "https://github.com/Sri01729/DHVANI-AI-project-Sri01729",
    platforms: [
      { icon: FaPython, color: "#00A4EF" },
      { icon: SiLangchain, color: "#00A4EF" },
      { icon: PiOpenAiLogo, color: "#00A4EF" },
      { icon: RiNextjsFill, color: "#00A4EF" },
    ],
