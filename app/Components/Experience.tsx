            ...
            >
              <div className="space-y-4 max-w-2xl mt-0 md:mt-32 md:pt-4">
                ...
                <p className="text-sm text-[#969696]">
                  I achieved a Cumulative <span className="text-[#fefeff]">GPA of 4.03/4.33</span>, showcasing my dedication to academic excellence. I was honored to receive the <span className="text-[#fefeff]">Leonard & Isabel Bryan Memorial Bursary Scholarship (2023)</span>, recognizing my exceptional performance and commitment to learning. Additionally, I was placed on the  <span className="text-[#fefeff]">Dean's Honour Roll (June 2024)</span> for consistently maintaining high grades and academic distinction.
                </p>
              </div>
            </motion.div>
            <br />
            ...
            >
              <div className="mt-8 md:mt-16">
                <div className="space-y-4 max-w-2xl">
                  ...
                  <p className="text-sm text-[#969696]">
                   As a Software Developer at Cognizant, I developed and maintained scalable web applications using modern frameworks like <span className="text-[#fefeff]"> React, Next.js, Node.js and Spring Boot</span>. I collaborated with cross-functional teams to deliver seamless user experiences, implemented efficient APIs, and optimized database solutions. By streamlining development workflows with CI/CD pipelines and mentoring junior developers, I contributed to fostering a collaborative and innovative environment while ensuring high-quality deliverables.
                  </p>
                </div>
              </div>
            </motion.div>
